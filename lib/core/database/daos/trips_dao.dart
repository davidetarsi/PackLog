  ...
  Future<String> duplicateTrip(String originalTripId, String newTripId) async {
    return transaction(() async {
      ...
      final newTrip = TripsCompanion.insert(
        ...
        primaryVibe: Value(originalTrip.primaryVibe),
        extraEvents: Value(originalTrip.extraEvents),
        avgTemperature: Value(originalTrip.avgTemperature),
        weatherTags: Value(originalTrip.weatherTags),
