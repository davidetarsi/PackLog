...
class DriftTripRepository implements TripRepository {
  ...
  TripsCompanion _toTripCompanion(model.TripModel trip) {
    ...
    return TripsCompanion(
      ...
      primaryVibe: Value(trip.primaryVibe),
      extraEvents: Value(trip.extraEvents),
      avgTemperature: Value(trip.avgTemperature),
      weatherTags: Value(trip.weatherTags),
