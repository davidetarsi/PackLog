...
class ItalianDictionary implements CategoryDictionary {
  ...
  List<({String root, ItemCategory category})> get rootKeywords => [
    ...
    (
      root: 'adatt',
      category: ItemCategory.elettronica,
    ), // adattatore, adattatore universale
    ...
    (
      root: 'comp',
      category: ItemCategory.elettronica,
    ), // computer, laptop, tablet, ipad, kindle, ebook, e-reader
    // Toiletries
    (
      root: 'anti',
      category: ItemCategory.toiletries,
    ), // antizanzare, antistaminico
    (
      root: 'truc',
      category: ItemCategory.toiletries,
    ), // trucco, trucchi, struccante
    ...
    (
      root: 'occh',
      category: ItemCategory.toiletries,
    ), // occhiali (da sole/vista), matita occhi
