...
android {
    namespace = "com.davidetarsi.packlog"
    ...
    defaultConfig {
        // Reverse-DNS del dominio davidetarsi.com. IMMUTABILE dopo il primo
        // upload su Play Store: il flavor dev vi appende ".dev" (vedi sotto).
        applicationId = "com.davidetarsi.packlog"
